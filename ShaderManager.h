...
public:
	...
	ShaderManager(const GLchar* vertexShaderPath,const GLchar* fragmentShaderPath,const GLchar* geometryShaderPath = nullptr)
	{
		...
		try
		{
			...
			if (geometryShaderPath != nullptr)
			{
				...
				geometryShaderStream << geometryFile.rdbuf();
				geometryFile.close();
