...
int main()
{
	...
	for (unsigned int i = 0; i < NR_LIGHTS; i++)
	{
		...
		float rColor = ((rand() % 1000) / 200.0f) + 0.5; // between 0.5 and 1.0
		float gColor = ((rand() % 1000) / 200.0f) + 0.5; // between 0.5 and 1.0
		float bColor = ((rand() % 1000) / 200.0f) + 0.5; // between 0.5 and 1.0
