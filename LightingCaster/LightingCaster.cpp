...
int main()
{
	...
	pShader.setFloat("light.outCutOff",glm::cos(glm::radians(17.5f)));
	...
	while (!glfwWindowShouldClose(pWindow))
	{
		...
		pShader.setVec3("light.position",pCamera.Position);
		pShader.setVec3("light.direction",pCamera.Front);
