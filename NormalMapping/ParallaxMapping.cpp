...
int main()
{
	...
	GLFWwindow* pWindow = glfwCreateWindow(SCR_WIDTH,SCR_HEIGHT,"Parallax Mapping",NULL,NULL);
	if (!pWindow)
	{
	...
	ShaderManager pShader("../shaders/NormalMapping/ParallaxMapping.vs", "../shaders/NormalMapping/ParallaxMapping.fs");
	pShader.use();
	pShader.setInt("texture1",0);
	pShader.setInt("normalTexture",1);
	pShader.setInt("depthTexture",2);
	//unsigned int texture1 = loadTexture("../resource/textures/bricks2.jpg",false);
	//unsigned int normalTexture = loadTexture("../resource/textures/bricks2_normal.jpg",false);
	//unsigned int depthTexture = loadTexture("../resource/textures/bricks2_disp.jpg",false);
	unsigned int texture1 = loadTexture("../resource/textures/wood.png",false);
	unsigned int normalTexture = loadTexture("../resource/textures/toy_box_normal.png",false);
	unsigned int depthTexture = loadTexture("../resource/textures/toy_box_disp.png",false);
	...
	{
		string str = "Parallax Mapping heightScale = " + to_string(height_scale) + " parallaxType = " + to_string(parallaxType) +
			" maxLayer = " + to_string(maxLayer); 
		...
		pShader.setFloat("height_scale",height_scale);
		pShader.setInt("parallaxType",parallaxType);
		pShader.setFloat("maxLayer",maxLayer);
