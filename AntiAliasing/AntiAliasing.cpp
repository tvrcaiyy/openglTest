...
int main()
{
	...
	// -------------------------
	ShaderManager pShader("../shaders/AntiAliasing/cubeVertex.vs", "../shaders/AntiAliasing/cubeFragment.fs");
	ShaderManager pScreenShader("../shaders/AntiAliasing/frameBufferVertex.vs", "../shaders/AntiAliasing/frameBufferFragment.fs");
	...
	glBindVertexArray(0);
	//------------------------------------------------------
	unsigned int framebuffer,multiSampledTexture,rbo;
	...
	//------------------------------------------------------
	unsigned int intermediateframebuffer,screenTexture;
	...
	glBindTexture(GL_TEXTURE_2D_MULTISAMPLE,0);
	if(glCheckFramebufferStatus(GL_FRAMEBUFFER) != GL_FRAMEBUFFER_COMPLETE)
		std::cout << "error::intermediateframebuffer:: intermediateframebuffer is not complete !" << std::endl;
	glBindFramebuffer(GL_FRAMEBUFFER, 0);
	//------------------------------------------------------
